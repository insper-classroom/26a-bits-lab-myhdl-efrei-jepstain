...
def toplevel(LEDR, SW, HEX0, HEX1):
    ...
    # Instatiations
    ic1 = exe4(ledr_s, SW) # Feito no ex4
    # ic2 = exe5(ledr_s, SW)
    # ic2 = sw2hex(HEX0, SW)
    # ic3 = bin2hex(HEX1, SW)
...
LEDR = Signal(intbv(0)[10:]) # Led RED
SW = Signal(intbv(0)[10:]) # Switch
KEY = Signal(intbv(0)[4:]) # Chave
HEX0 = Signal(intbv(1)[7:]) # Displays 1 a 7
